...
//B_Z_AF_Controller_T *Z_AF_Controller_B;
//DW_Z_AF_Controller_T *Z_AF_Controller_DW;
real32_T Z_AF_Controller_U_engine_speed_radps, Z_AF_Controller_U_throttle_angle_deg, Z_AF_Controller_U_throttle_flow_gps, Z_AF_Controller_U_airbyfuel_meas, *Z_AF_Controller_Y_commanded_fuel_gps;
boolean_T *Z_AF_Controller_Y_controller_mode;
real32_T *Z_AF_Controller_Y_airbyfuel_ref;


//Pushed this declaration and assignment of values to the struct elements, So that LLVM can do constant propagation in IR outside the function it fails do constant propagation.
...
P_Z_AF_Controller_T Z_AF_Controller_P = {
  ...
  //Z_AF_Controller_step(&Z_AF_Controller_B, &Z_AF_Controller_DW, engine_speed, throttle_angle, throttle_flow, airbyfuel_meas, &commanded_fuel_gps, &controller_mode, &airbyfuel_ref);

//void Z_AF_Controller_step(B_Z_AF_Controller_T *Z_AF_Controller_B, DW_Z_AF_Controller_T *Z_AF_Controller_DW, real32_T Z_AF_Controller_U_engine_speed_radps, real32_T  Z_AF_Controller_U_throttle_angle_deg, real32_T  Z_AF_Controller_U_throttle_flow_gps, real32_T Z_AF_Controller_U_airbyfuel_meas,  real32_T *Z_AF_Controller_Y_commanded_fuel_gps, boolean_T  *Z_AF_Controller_Y_controller_mode, real32_T *Z_AF_Controller_Y_airbyfuel_ref)



//*Z_AF_Controller_B = &Z_AF_Controller_B;
//*Z_AF_Controller_DW = &Z_AF_Controller_DW;
...
//output to plant
 ...
 // ret_val->c_controller_mode = controller_mode;
 // ret_val->c_airbyfuel_ref = airbyfuel_ref;
