...
#define thetaHat (c6 + c7*throttle_angle + c8*throttle_angle*throttle_angle + c9*throttle_angle*throttle_angle*throttle_angle)
#define dmAf       (2 * thetaHat * (c20*manifold_pressure*manifold_pressure+c21*manifold_pressure+c22))
#define mCf(x)     (c2 + c3*engine_speed*x + c4*engine_speed*x*x + c5*engine_speed*engine_speed*x)
