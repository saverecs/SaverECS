...
(declare-fun time_3 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_3 u_3_0 )  
 (= lt_3_t (+ lt_3_0 (* 1 time_3 ))) (= gt_3_t (+ gt_3_0 (* 1 time_3 ))) (= u_3_t (+ u_3_0 (* 0 0.1 ))) 
 (= [gt_3_t lt_3_t x_3_t v_3_t u_3_t ] (integral 0. time_3 [gt_3_0 lt_3_0 x_3_0 v_3_0 u_3_0 ] flow_1))  
 (forall_t 1 [0 time_3] (<= lt_3_t 0.1))   
 (<= lt_3_t 0.1) (<= lt_3_0 0.1) (= mode_3 1)  
 (> v_3_t 0.013475894  )(> gt_3_t 5  ) ))
 (check-sat)
(exit)