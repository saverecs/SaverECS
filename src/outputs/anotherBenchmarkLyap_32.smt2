...
(declare-fun time_32 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_32 u_32_0 )  
 (= lt_32_t (+ lt_32_0 (* 1 time_32 ))) (= gt_32_t (+ gt_32_0 (* 1 time_32 ))) (= u_32_t (+ u_32_0 (* 0 0.1 ))) 
 (= [gt_32_t lt_32_t x_32_t v_32_t u_32_t ] (integral 0. time_32 [gt_32_0 lt_32_0 x_32_0 v_32_0 u_32_0 ] flow_1))  
 (forall_t 1 [0 time_32] (<= lt_32_t 0.1))   
 (<= lt_32_t 0.1) (<= lt_32_0 0.1) (= mode_32 1)  
 (> v_32_t 0.013475894  )(> gt_32_t 5  ) ))
 (check-sat)
(exit)