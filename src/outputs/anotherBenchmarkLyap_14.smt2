...
(declare-fun time_14 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_14 u_14_0 )  
 (= lt_14_t (+ lt_14_0 (* 1 time_14 ))) (= gt_14_t (+ gt_14_0 (* 1 time_14 ))) (= u_14_t (+ u_14_0 (* 0 0.1 ))) 
 (= [gt_14_t lt_14_t x_14_t v_14_t u_14_t ] (integral 0. time_14 [gt_14_0 lt_14_0 x_14_0 v_14_0 u_14_0 ] flow_1))  
 (forall_t 1 [0 time_14] (<= lt_14_t 0.1))   
 (<= lt_14_t 0.1) (<= lt_14_0 0.1) (= mode_14 1)  
 (> v_14_t 0.013475894  )(> gt_14_t 5  ) ))
 (check-sat)
(exit)