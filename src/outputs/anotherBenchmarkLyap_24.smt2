...
(declare-fun time_24 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_24 u_24_0 )  
 (= lt_24_t (+ lt_24_0 (* 1 time_24 ))) (= gt_24_t (+ gt_24_0 (* 1 time_24 ))) (= u_24_t (+ u_24_0 (* 0 0.1 ))) 
 (= [gt_24_t lt_24_t x_24_t v_24_t u_24_t ] (integral 0. time_24 [gt_24_0 lt_24_0 x_24_0 v_24_0 u_24_0 ] flow_1))  
 (forall_t 1 [0 time_24] (<= lt_24_t 0.1))   
 (<= lt_24_t 0.1) (<= lt_24_0 0.1) (= mode_24 1)  
 (> v_24_t 0.013475894  )(> gt_24_t 5  ) ))
 (check-sat)
(exit)