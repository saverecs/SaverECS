...
(declare-fun time_29 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_29 u_29_0 )  
 (= lt_29_t (+ lt_29_0 (* 1 time_29 ))) (= gt_29_t (+ gt_29_0 (* 1 time_29 ))) (= u_29_t (+ u_29_0 (* 0 0.1 ))) 
 (= [gt_29_t lt_29_t x_29_t v_29_t u_29_t ] (integral 0. time_29 [gt_29_0 lt_29_0 x_29_0 v_29_0 u_29_0 ] flow_1))  
 (forall_t 1 [0 time_29] (<= lt_29_t 0.1))   
 (<= lt_29_t 0.1) (<= lt_29_0 0.1) (= mode_29 1)  
 (> v_29_t 0.013475894  )(> gt_29_t 5  ) ))
 (check-sat)
(exit)