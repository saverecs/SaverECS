...
(declare-fun time_12 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_12 u_12_0 )  
 (= lt_12_t (+ lt_12_0 (* 1 time_12 ))) (= gt_12_t (+ gt_12_0 (* 1 time_12 ))) (= u_12_t (+ u_12_0 (* 0 0.1 ))) 
 (= [gt_12_t lt_12_t x_12_t v_12_t u_12_t ] (integral 0. time_12 [gt_12_0 lt_12_0 x_12_0 v_12_0 u_12_0 ] flow_1))  
 (forall_t 1 [0 time_12] (<= lt_12_t 0.1))   
 (<= lt_12_t 0.1) (<= lt_12_0 0.1) (= mode_12 1)  
 (> v_12_t 0.013475894  )(> gt_12_t 5  ) ))
 (check-sat)
(exit)