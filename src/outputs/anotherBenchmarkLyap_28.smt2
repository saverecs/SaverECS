...
(declare-fun time_28 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_28 u_28_0 )  
 (= lt_28_t (+ lt_28_0 (* 1 time_28 ))) (= gt_28_t (+ gt_28_0 (* 1 time_28 ))) (= u_28_t (+ u_28_0 (* 0 0.1 ))) 
 (= [gt_28_t lt_28_t x_28_t v_28_t u_28_t ] (integral 0. time_28 [gt_28_0 lt_28_0 x_28_0 v_28_0 u_28_0 ] flow_1))  
 (forall_t 1 [0 time_28] (<= lt_28_t 0.1))   
 (<= lt_28_t 0.1) (<= lt_28_0 0.1) (= mode_28 1)  
 (> v_28_t 0.013475894  )(> gt_28_t 5  ) ))
 (check-sat)
(exit)