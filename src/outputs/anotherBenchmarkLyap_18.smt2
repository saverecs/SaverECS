...
(declare-fun time_18 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_18 u_18_0 )  
 (= lt_18_t (+ lt_18_0 (* 1 time_18 ))) (= gt_18_t (+ gt_18_0 (* 1 time_18 ))) (= u_18_t (+ u_18_0 (* 0 0.1 ))) 
 (= [gt_18_t lt_18_t x_18_t v_18_t u_18_t ] (integral 0. time_18 [gt_18_0 lt_18_0 x_18_0 v_18_0 u_18_0 ] flow_1))  
 (forall_t 1 [0 time_18] (<= lt_18_t 0.1))   
 (<= lt_18_t 0.1) (<= lt_18_0 0.1) (= mode_18 1)  
 (> v_18_t 0.013475894  )(> gt_18_t 5  ) ))
 (check-sat)
(exit)