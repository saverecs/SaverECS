...
(declare-fun time_23 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_23 u_23_0 )  
 (= lt_23_t (+ lt_23_0 (* 1 time_23 ))) (= gt_23_t (+ gt_23_0 (* 1 time_23 ))) (= u_23_t (+ u_23_0 (* 0 0.1 ))) 
 (= [gt_23_t lt_23_t x_23_t v_23_t u_23_t ] (integral 0. time_23 [gt_23_0 lt_23_0 x_23_0 v_23_0 u_23_0 ] flow_1))  
 (forall_t 1 [0 time_23] (<= lt_23_t 0.1))   
 (<= lt_23_t 0.1) (<= lt_23_0 0.1) (= mode_23 1)  
 (> v_23_t 0.013475894  )(> gt_23_t 5  ) ))
 (check-sat)
(exit)