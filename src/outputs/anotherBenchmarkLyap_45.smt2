...
(declare-fun time_45 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_45 u_45_0 )  
 (= lt_45_t (+ lt_45_0 (* 1 time_45 ))) (= gt_45_t (+ gt_45_0 (* 1 time_45 ))) (= u_45_t (+ u_45_0 (* 0 0.1 ))) 
 (= [gt_45_t lt_45_t x_45_t v_45_t u_45_t ] (integral 0. time_45 [gt_45_0 lt_45_0 x_45_0 v_45_0 u_45_0 ] flow_1))  
 (forall_t 1 [0 time_45] (<= lt_45_t 0.1))   
 (<= lt_45_t 0.1) (<= lt_45_0 0.1) (= mode_45 1)  
 (> v_45_t 0.013475894  )(> gt_45_t 5  ) ))
 (check-sat)
(exit)