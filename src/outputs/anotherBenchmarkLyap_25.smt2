...
(declare-fun time_25 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_25 u_25_0 )  
 (= lt_25_t (+ lt_25_0 (* 1 time_25 ))) (= gt_25_t (+ gt_25_0 (* 1 time_25 ))) (= u_25_t (+ u_25_0 (* 0 0.1 ))) 
 (= [gt_25_t lt_25_t x_25_t v_25_t u_25_t ] (integral 0. time_25 [gt_25_0 lt_25_0 x_25_0 v_25_0 u_25_0 ] flow_1))  
 (forall_t 1 [0 time_25] (<= lt_25_t 0.1))   
 (<= lt_25_t 0.1) (<= lt_25_0 0.1) (= mode_25 1)  
 (> v_25_t 0.013475894  )(> gt_25_t 5  ) ))
 (check-sat)
(exit)