...
(declare-fun time_16 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_16 u_16_0 )  
 (= lt_16_t (+ lt_16_0 (* 1 time_16 ))) (= gt_16_t (+ gt_16_0 (* 1 time_16 ))) (= u_16_t (+ u_16_0 (* 0 0.1 ))) 
 (= [gt_16_t lt_16_t x_16_t v_16_t u_16_t ] (integral 0. time_16 [gt_16_0 lt_16_0 x_16_0 v_16_0 u_16_0 ] flow_1))  
 (forall_t 1 [0 time_16] (<= lt_16_t 0.1))   
 (<= lt_16_t 0.1) (<= lt_16_0 0.1) (= mode_16 1)  
 (> v_16_t 0.013475894  )(> gt_16_t 5  ) ))
 (check-sat)
(exit)