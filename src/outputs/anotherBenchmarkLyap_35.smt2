...
(declare-fun time_35 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_35 u_35_0 )  
 (= lt_35_t (+ lt_35_0 (* 1 time_35 ))) (= gt_35_t (+ gt_35_0 (* 1 time_35 ))) (= u_35_t (+ u_35_0 (* 0 0.1 ))) 
 (= [gt_35_t lt_35_t x_35_t v_35_t u_35_t ] (integral 0. time_35 [gt_35_0 lt_35_0 x_35_0 v_35_0 u_35_0 ] flow_1))  
 (forall_t 1 [0 time_35] (<= lt_35_t 0.1))   
 (<= lt_35_t 0.1) (<= lt_35_0 0.1) (= mode_35 1)  
 (> v_35_t 0.013475894  )(> gt_35_t 5  ) ))
 (check-sat)
(exit)