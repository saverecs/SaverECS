...
(declare-fun time_22 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_22 u_22_0 )  
 (= lt_22_t (+ lt_22_0 (* 1 time_22 ))) (= gt_22_t (+ gt_22_0 (* 1 time_22 ))) (= u_22_t (+ u_22_0 (* 0 0.1 ))) 
 (= [gt_22_t lt_22_t x_22_t v_22_t u_22_t ] (integral 0. time_22 [gt_22_0 lt_22_0 x_22_0 v_22_0 u_22_0 ] flow_1))  
 (forall_t 1 [0 time_22] (<= lt_22_t 0.1))   
 (<= lt_22_t 0.1) (<= lt_22_0 0.1) (= mode_22 1)  
 (> v_22_t 0.013475894  )(> gt_22_t 5  ) ))
 (check-sat)
(exit)