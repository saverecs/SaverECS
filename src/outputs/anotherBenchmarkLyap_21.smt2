...
(declare-fun time_21 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_21 u_21_0 )  
 (= lt_21_t (+ lt_21_0 (* 1 time_21 ))) (= gt_21_t (+ gt_21_0 (* 1 time_21 ))) (= u_21_t (+ u_21_0 (* 0 0.1 ))) 
 (= [gt_21_t lt_21_t x_21_t v_21_t u_21_t ] (integral 0. time_21 [gt_21_0 lt_21_0 x_21_0 v_21_0 u_21_0 ] flow_1))  
 (forall_t 1 [0 time_21] (<= lt_21_t 0.1))   
 (<= lt_21_t 0.1) (<= lt_21_0 0.1) (= mode_21 1)  
 (> v_21_t 0.013475894  )(> gt_21_t 5  ) ))
 (check-sat)
(exit)