...
(declare-fun time_13 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_13 u_13_0 )  
 (= lt_13_t (+ lt_13_0 (* 1 time_13 ))) (= gt_13_t (+ gt_13_0 (* 1 time_13 ))) (= u_13_t (+ u_13_0 (* 0 0.1 ))) 
 (= [gt_13_t lt_13_t x_13_t v_13_t u_13_t ] (integral 0. time_13 [gt_13_0 lt_13_0 x_13_0 v_13_0 u_13_0 ] flow_1))  
 (forall_t 1 [0 time_13] (<= lt_13_t 0.1))   
 (<= lt_13_t 0.1) (<= lt_13_0 0.1) (= mode_13 1)  
 (> v_13_t 0.013475894  )(> gt_13_t 5  ) ))
 (check-sat)
(exit)