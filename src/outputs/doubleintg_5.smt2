...
(declare-fun time_5 () Real [0.000000, 0.051])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= a_0_0 0 )(= v_0_0 0 )(= x_0_0 0 )(= mode_0 1)  
 ...
 (= next_a_5 a_5_0 )  
 (= lt_5_t (+ lt_5_0 (* 1 time_5 ))) (= gt_5_t (+ gt_5_0 (* 1 time_5 ))) (= a_5_t (+ a_5_0 (* 0 0.05 ))) 
 (= [gt_5_t lt_5_t x_5_t v_5_t a_5_t ] (integral 0. time_5 [gt_5_0 lt_5_0 x_5_0 v_5_0 a_5_0 ] flow_1))  
 (forall_t 1 [0 time_5] (<= lt_5_t 0.051))   
 (<= lt_5_t 0.051) (<= lt_5_0 0.051) (= mode_5 1)  
 (> gt_5_t 1  ) ))
 (check-sat)
(exit)