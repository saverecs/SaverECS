...
(declare-fun time_7 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_7 u_7_0 )  
 (= lt_7_t (+ lt_7_0 (* 1 time_7 ))) (= gt_7_t (+ gt_7_0 (* 1 time_7 ))) (= u_7_t (+ u_7_0 (* 0 0.1 ))) 
 (= [gt_7_t lt_7_t x_7_t v_7_t u_7_t ] (integral 0. time_7 [gt_7_0 lt_7_0 x_7_0 v_7_0 u_7_0 ] flow_1))  
 (forall_t 1 [0 time_7] (<= lt_7_t 0.1))   
 (<= lt_7_t 0.1) (<= lt_7_0 0.1) (= mode_7 1)  
 (> v_7_t 0.013475894  )(> gt_7_t 5  ) ))
 (check-sat)
(exit)