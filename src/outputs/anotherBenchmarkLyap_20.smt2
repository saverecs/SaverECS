...
(declare-fun time_20 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_20 u_20_0 )  
 (= lt_20_t (+ lt_20_0 (* 1 time_20 ))) (= gt_20_t (+ gt_20_0 (* 1 time_20 ))) (= u_20_t (+ u_20_0 (* 0 0.1 ))) 
 (= [gt_20_t lt_20_t x_20_t v_20_t u_20_t ] (integral 0. time_20 [gt_20_0 lt_20_0 x_20_0 v_20_0 u_20_0 ] flow_1))  
 (forall_t 1 [0 time_20] (<= lt_20_t 0.1))   
 (<= lt_20_t 0.1) (<= lt_20_0 0.1) (= mode_20 1)  
 (> v_20_t 0.013475894  )(> gt_20_t 5  ) ))
 (check-sat)
(exit)