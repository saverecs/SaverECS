...
(declare-fun time_11 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_11 u_11_0 )  
 (= lt_11_t (+ lt_11_0 (* 1 time_11 ))) (= gt_11_t (+ gt_11_0 (* 1 time_11 ))) (= u_11_t (+ u_11_0 (* 0 0.1 ))) 
 (= [gt_11_t lt_11_t x_11_t v_11_t u_11_t ] (integral 0. time_11 [gt_11_0 lt_11_0 x_11_0 v_11_0 u_11_0 ] flow_1))  
 (forall_t 1 [0 time_11] (<= lt_11_t 0.1))   
 (<= lt_11_t 0.1) (<= lt_11_0 0.1) (= mode_11 1)  
 (> v_11_t 0.013475894  )(> gt_11_t 5  ) ))
 (check-sat)
(exit)