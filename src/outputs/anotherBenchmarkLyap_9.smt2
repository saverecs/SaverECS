...
(declare-fun time_9 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_9 u_9_0 )  
 (= lt_9_t (+ lt_9_0 (* 1 time_9 ))) (= gt_9_t (+ gt_9_0 (* 1 time_9 ))) (= u_9_t (+ u_9_0 (* 0 0.1 ))) 
 (= [gt_9_t lt_9_t x_9_t v_9_t u_9_t ] (integral 0. time_9 [gt_9_0 lt_9_0 x_9_0 v_9_0 u_9_0 ] flow_1))  
 (forall_t 1 [0 time_9] (<= lt_9_t 0.1))   
 (<= lt_9_t 0.1) (<= lt_9_0 0.1) (= mode_9 1)  
 (> v_9_t 0.013475894  )(> gt_9_t 5  ) ))
 (check-sat)
(exit)