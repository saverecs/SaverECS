...
(declare-fun time_27 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_27 u_27_0 )  
 (= lt_27_t (+ lt_27_0 (* 1 time_27 ))) (= gt_27_t (+ gt_27_0 (* 1 time_27 ))) (= u_27_t (+ u_27_0 (* 0 0.1 ))) 
 (= [gt_27_t lt_27_t x_27_t v_27_t u_27_t ] (integral 0. time_27 [gt_27_0 lt_27_0 x_27_0 v_27_0 u_27_0 ] flow_1))  
 (forall_t 1 [0 time_27] (<= lt_27_t 0.1))   
 (<= lt_27_t 0.1) (<= lt_27_0 0.1) (= mode_27 1)  
 (> v_27_t 0.013475894  )(> gt_27_t 5  ) ))
 (check-sat)
(exit)