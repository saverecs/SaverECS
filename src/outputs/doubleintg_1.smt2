...
(declare-fun time_1 () Real [0.000000, 0.051])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= a_0_0 0 )(= v_0_0 0 )(= x_0_0 0 )(= mode_0 1)  
 ...
 (= next_a_1 a_1_0 )  
 (= lt_1_t (+ lt_1_0 (* 1 time_1 ))) (= gt_1_t (+ gt_1_0 (* 1 time_1 ))) (= a_1_t (+ a_1_0 (* 0 0.05 ))) 
 (= [gt_1_t lt_1_t x_1_t v_1_t a_1_t ] (integral 0. time_1 [gt_1_0 lt_1_0 x_1_0 v_1_0 a_1_0 ] flow_1))  
 (forall_t 1 [0 time_1] (<= lt_1_t 0.051))   
 (<= lt_1_t 0.051) (<= lt_1_0 0.051) (= mode_1 1)  
 (> gt_1_t 1  ) ))
 (check-sat)
(exit)