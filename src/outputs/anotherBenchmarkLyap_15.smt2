...
(declare-fun time_15 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_15 u_15_0 )  
 (= lt_15_t (+ lt_15_0 (* 1 time_15 ))) (= gt_15_t (+ gt_15_0 (* 1 time_15 ))) (= u_15_t (+ u_15_0 (* 0 0.1 ))) 
 (= [gt_15_t lt_15_t x_15_t v_15_t u_15_t ] (integral 0. time_15 [gt_15_0 lt_15_0 x_15_0 v_15_0 u_15_0 ] flow_1))  
 (forall_t 1 [0 time_15] (<= lt_15_t 0.1))   
 (<= lt_15_t 0.1) (<= lt_15_0 0.1) (= mode_15 1)  
 (> v_15_t 0.013475894  )(> gt_15_t 5  ) ))
 (check-sat)
(exit)