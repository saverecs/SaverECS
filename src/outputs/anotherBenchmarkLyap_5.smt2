...
(declare-fun time_5 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_5 u_5_0 )  
 (= lt_5_t (+ lt_5_0 (* 1 time_5 ))) (= gt_5_t (+ gt_5_0 (* 1 time_5 ))) (= u_5_t (+ u_5_0 (* 0 0.1 ))) 
 (= [gt_5_t lt_5_t x_5_t v_5_t u_5_t ] (integral 0. time_5 [gt_5_0 lt_5_0 x_5_0 v_5_0 u_5_0 ] flow_1))  
 (forall_t 1 [0 time_5] (<= lt_5_t 0.1))   
 (<= lt_5_t 0.1) (<= lt_5_0 0.1) (= mode_5 1)  
 (> v_5_t 0.013475894  )(> gt_5_t 5  ) ))
 (check-sat)
(exit)