...
(declare-fun time_2 () Real [0.000000, 0.1])
...
(assert (and (= lt_0_0 0) (= gt_0_0 0) (= v_0_0 2 )(= u_0_0 1 )(= x_0_0 1 )(= mode_0 1)  
 ...
 (= next_u_2 u_2_0 )  
 (= lt_2_t (+ lt_2_0 (* 1 time_2 ))) (= gt_2_t (+ gt_2_0 (* 1 time_2 ))) (= u_2_t (+ u_2_0 (* 0 0.1 ))) 
 (= [gt_2_t lt_2_t x_2_t v_2_t u_2_t ] (integral 0. time_2 [gt_2_0 lt_2_0 x_2_0 v_2_0 u_2_0 ] flow_1))  
 (forall_t 1 [0 time_2] (<= lt_2_t 0.1))   
 (<= lt_2_t 0.1) (<= lt_2_0 0.1) (= mode_2 1)  
 (> v_2_t 0.013475894  )(> gt_2_t 5  ) ))
 (check-sat)
(exit)